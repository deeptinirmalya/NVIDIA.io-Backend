...
# ================================= FOR SINGLE+PAID EVENTS ================================
    ...
    async def check_or_create_single_paid_registration(
        ...
        try:
            ...
            #check idempotency — return early if duplicate key found
            idempotency_response = await PaymentServices.check_idempotency_key(db, idempotency_key, event_id, user_id)
